...
class BasicSpectrum:
    ...
    def __init__(self, x, y, sort=True, name=None, name_x=None, name_y=None):
        ...
        if sort:
            self.sort = True
            self.data_table = pd.DataFrame({self.name_x: x, self.name_y: y}).sort_values(
                by=[self.name_x]).reset_index(drop=True)
        else:
            if x[0] < x[-1]:
                self.sort = True
            else:
    ...
    def _minMaxIndex(self, low, high):
        ...
        high_index = (self.data_table[self.name_x] -
                      high).abs().sort_values().index[0] + 1
        low_index = (self.data_table[self.name_x] - \
                     low).abs().sort_values().index[0] - self.data_table.index[0]
    ...
    def transformXvector(self, func, new_name, undo=False):
        ...
        if undo and self._xtranformed:
            ...
            self.data_table[self.name_x] = self.data_table[self.old_x_name].apply(
                lambda x: func(x))
    ...
    def cut(self, low=None, high=None, itself=True):
        ...
        if itself:
            ...
            return BasicSpectrum(data_table[self.name_x],
    ...
    def __sub__(self, obj):
        ...
        ret_obj = BasicSpectrum(self.data_table[self.name_x],
                                self.data_table[self.name_y],
                                True,
                                self.name,
                                self.name_x,
                                self.name_y)
        ret_obj.data_table[ret_obj.name_y] = self.data_table[self.name_y] - \
            obj.data_table[obj.name_y]
        return ret_obj
    ...
    def __add__(self, obj):
        ...
        ret_obj = BasicSpectrum(self.data_table[self.name_x],
                                ...
                                self.name_x,
                                self.name_y)
        ret_obj.data_table[ret_obj.name_y] = ret_obj.data_table[ret_obj.name_y] + \
            obj.data_table[obj.name_y]
        return ret_obj
    ...
    def obtainValue(self, value):
        ...
        float
           y value
        '''
        index_value = (self.data_table[self.name_x] -
                       value).abs().sort_values().index[0]
    ...
    def forcePositive(self, itself=True):
        ...
        if mini < 0:
            if itself:
                ...
                spec = BasicSpectrum(self.data_table[self.name_x],
    ...
    def normalize(self, wavelength=None, low=None, high=None, itself=True):
        ...
        if itself:
            ...
            spec = BasicSpectrum(data[self.name_x],
                                 data[self.name_y],
                                 True,
                                 self.name,
                                 self.name_x,
    ...
    def plotSpectrum(self, axes='current', x_label=None, y_label=None,
        ...
        if fill:
            ax1.plot(self.data_table[self.name_x],
                     self.data_table[self.name_y], **kwargs)
            plt.fill_between(self.data_table[self.name_x],
                             self.data_table[self.name_y],
        ...
        plt.tick_params(
            ...
            which='major',
            labelsize=plot_properties['fsize'])
        plt.xlim(self.data_table[self.name_x][self.data_table.index[0]],
