...
class TestExperiment(unittest.TestCase):
    ...
    def check_preprocessing_function(self, name, extra=None):
        ...
        data_added = hasattr(self.experiment.preprocessing.data_sets,
                             "before_" + name)
    ...
    def test_restore_data(self, action):
        ...
        if action == "baseline_substraction":
            ...
            experiment.preprocessing.calibrate_wavelength([1500, 1600, 1650],
                                                          [1, 200, 300])
        ...
        experiment.preprocessing.restore_data(action)
        container = getattr(experiment.preprocessing.data_sets,
                            f"before_{action}")
